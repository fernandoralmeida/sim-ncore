...
namespace Sim.Data.Context
{
    ...
    {
        private static string _connectionstring = Environment.GetEnvironmentVariable("App_____ContextConnection"); // @"Server=127.0.0.1,1433\\sql1;Database=Sim-Application-db20210001;User Id=sa;Password=sql@1234;";
