...
public class IndexModel : PageModel {
    ...
    public async Task OnGetAsync() {        
        MeusContratos = await _appcontratos.DoListAsync(s => s.AppUser == User.Identity.Name && s.Situacao == EContrato.EnSituacao.Aprovado && s.Pagamento == EContrato.EnPagamento.Adimplente);      
