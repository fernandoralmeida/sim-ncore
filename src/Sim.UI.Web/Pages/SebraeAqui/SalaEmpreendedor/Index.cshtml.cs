...
namespace Sim.UI.Web.Pages.SebraeAqui.SalaEmpreendedor;
...
public class IndexModel : PageModel
{
    ...
    public async Task OnGetAsync() {
        ...
        var _list_ev = await _appevento.DoListAsync(s => s.Data.Value.Year == InputAno && s.Owner == "Sala do Empreendedor" && s.Situacao != EEvento.ESituacao.Cancelado);
        var _list_at = await _appatendimento.DoListAsync(s => s.Data.Value.Year == InputAno && s.Setor == "Sala do Empreendedor");
